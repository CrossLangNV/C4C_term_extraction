...
from .BERT import BERTForSentenceClassification
...
class BERTForDefinitionClassification(BERTForSentenceClassification):
    ...
    @classmethod
    def from_bert(cls, model_storage_directory: Path) -> BERTForSentenceClassification:
        ...
        return cls.from_bert_model(model_storage_directory=model_storage_directory,
                                   output_dim=2,
                                   bert_model='dbmdz/bert-base-german-uncased'  #AK
                                   )
